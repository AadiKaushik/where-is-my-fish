...
function spawnPlastic()
{
    if(frameCount% 100===0 )
    {
          ...
          var plastic = createSprite(random(0 , displayWidth*6),-500, 60, 60);
...
function spawnTires()
{
  if(frameCount%  150 === 0 )
  {
     tyres = createSprite(random(-3107,displayWidth*6),-500, 20,20);
     tyres.velocityY =6 ;
...
function spawnPlasticBottles()
{
  ...
  var  plasticBottles = createSprite(random(-3107,displayWidth*5), -500, 20, 20);
    ...
    plasticBottles.scale = 2;
plasticBottles.velocityX=6
